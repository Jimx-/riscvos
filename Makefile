...
SRCS		= head.S trap.S main.c fdt.c proc.c sched.c vm.c global.c direct_tty.c memory.c exc.c syscall.c irq.c timer.c user.c gate.S alloc.c $(LIBSRCS) $(EXTSRCS)
